...
import { selectUser, selectUserProfile, selectUserRole, setSignOut, } from '../../../redux/slices/auth.slice';
        ...
        <View style={styles.contentContainer}>
          {hasData ? (
            <>
              {hasActiveTraslado && (
                <>
                  <Text style={styles.sectionHeader}>{t.tripInProgress}</Text>
                  {trasladosData
                    .filter(item => item.enCurso)
                    .map(item => renderTrasladoItem({item}))}
                </>
              )}
              <Text style={styles.sectionHeader}>{t.recentTrips}</Text>
              <FlatList
          ...
          {userRole === 'TURIST' && (
            <View
              ...
              <TouchableOpacity
                ...
                <Text style={styles.buttonText}>{t.startNewTrip}</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
