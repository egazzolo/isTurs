          ...
          <ScrollView
            ...
            <View style={styles.InfoCompany}>
              ...
              <View style={styles.infoCompanyData}>
                ...
                <Text style={styles.dataText}>{t.companyCodeLabel} {userData?.code}</Text>
                <Text style={styles.dataText}>{t.commercialName}</Text>
                <Text style={styles.dataText}>{t.phone}</Text>
                <Text style={styles.dataText}>
                  {t.companyTypeLabel} {userData?.type_company}
                </Text>
              </View>
            </View>
            ...
            <View
              ...
              <View style={styles.CountDetails}>
                ...
                <Text style={styles.dataText}>{t.transferors}</Text>
              </View>
              <View style={styles.CountDetails}>
                <View style={styles.DetailsIcon}>
                  <RenderSvgXML
                ...
                <Text style={styles.dataText}>{t.touristRole}</Text>
              </View>
              <View style={styles.CountDetails}>
                <View style={styles.DetailsIcon}>
                  <RenderSvgXML
            ...
            <TouchableOpacity
              ...
              <Text style={styles.buttonText}>{t.driversList}</Text>
            </TouchableOpacity>
